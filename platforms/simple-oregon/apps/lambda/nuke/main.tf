module "iam" {
  source      = "git::ssh://git@github.com/BeanTraining/terraform-infra-skeleton.git//services/iam_for_lambda"
  environment = var.environment
}

module "lambda" {
  depends_on               = [module.iam]
  source                   = "git::ssh://git@github.com/BeanTraining/terraform-infra-skeleton.git//services/lambda_function_service"
