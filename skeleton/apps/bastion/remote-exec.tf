...
resource "null_resource" "bastion_provisioner" {
  ...
  provisioner "remote-exec" {
    inline = [  
      ...
      "~/terraform-init.sh '${var.github_oauth_token}' '${var.tfe_token}' '${var.aws_access_key_id}' '${var.aws_secret_access_key}' '${var.aws_region}' '${var.organisation}'  '${var.environment}' > ~/terraform-init.log"
    ]
  }
